  ...
  describe("#isValidGlbFormat", () => {
    const testCases = [
      ...
      { name: "invalid empty URL/base64", format: "", expected: false },
      {
        ...
        format: "/3d-test-model.gl?morphTargets=true",
        expected: false,
      },
      {
        name: "invalid base64 format",
        format:
          "data:application/octet-stream;base64Z2xURgIAAAC4aKAAqA4CAEpTT...",
        expected: false,
      },
      ...
      },
      {
        ...
        format:
          "data:application/octet-stream;base64,Z2xURgIAAAC4aKAAqA4CAEpTT...",
        expected: true,
      },
      {
