...
export const ignoreArgTypesOnExamples = keysToIgnore.reduce((acc, key) => {
...
export const modelPresets = {
  ...
  seven:
    "https://models.readyplayer.me/64e3055495439dfcf3f0b665.glb?morphTargets=ARKit,Eyes%20Extra&textureAtlas=none",
};
