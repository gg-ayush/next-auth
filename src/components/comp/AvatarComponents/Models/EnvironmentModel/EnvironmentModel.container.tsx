...
import {
  EnvironmentModels,
  environmentModels,
} from "@/services/avatar/Environment.service";
import {
  EnvironmentModel,
  EnvironmentModelProps,
} from "./EnvironmentModel.component";
...
export const EnvironmentModelContainer: FC<EnvironmentModelProps> = (props) => {
  ...
  const environmentSrc = isStaticPreset
    ? environmentModels[environment as EnvironmentModels]
    : environment;
